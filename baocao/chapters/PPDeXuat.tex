...
\begin{center}
\includegraphics[height=0.65\textheight,width=\textwidth,keepaspectratio]{img/mermaid/arch_overview.png}
...
\begin{center}
\includegraphics[width=\textwidth]{img/mermaid/er_diagram.png}
